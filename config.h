...
static const char *slockcmd[] = { "lock-comp.sh" };
...
static const char *music_prev[] = { "adj-music.sh", "-" };
static const char *music_next[] = { "adj-music.sh", "+" };
static const char *music_play[] = { "adj-music.sh", "." };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_F10,    spawn,          {.v = music_prev } },
	{ MODKEY|ShiftMask,             XK_F11,    spawn,          {.v = music_play } },
	{ MODKEY|ShiftMask,             XK_F12,    spawn,          {.v = music_next } },
